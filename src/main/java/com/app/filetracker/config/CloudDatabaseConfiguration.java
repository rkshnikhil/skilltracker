package com.app.filetracker.config;
...
@Configuration
@EnableMongoRepositories("com.app.filetracker.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.app.filetracker.config.dbmigrations");
